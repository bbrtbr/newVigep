...
use App\Models\Patients, App\Models\Addresses, App\Models\Cases\InfluenzaCases, App\Models\HealthUnits, App\Models\HealthWorkers;

class influenzaCasesController extends Controller
{
    public function index()
    {
        
            $healthUnits = HealthUnits::all();
        return view('vigep.forms.influenza', compact('healthUnits','healthWorkers'));
    ...
    public function storeOrUpdate(Request $request)
    {
        ...
        if ($request->has('case_id')) {
            ...
            $case->save();
            $healthWorker->save();
            $influenzaCases = InfluenzaCases::create($request->all());
            $influenzaCases->get_case_id = $case->case_id;
            $influenzaCases->save();
        }
    ...
    public function edit($id)
    {
        ...
        $influenzaCases = InfluenzaCases::where('get_case_id', $id)->first();
        return view('vigep.forms.influenza', compact('case', 'influenzaCases'));
    }
}
