...
<head>
    ...
    <title>Programa Eficiência - Esqueci a senha</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ route('password.email') }}" class="user">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-user btn-block">Enviar Email</button>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{ route('login') }}">Já tem uma senha? Login!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
